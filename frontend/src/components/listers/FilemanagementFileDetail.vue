<template>
    <v-card outlined>
        ...
        <v-card-text>
            ...
            <div>
                <String label="UploadedBy" v-model="item.uploadedBy" :editMode="editMode" @change="change" />
            </div>
            <div>
                <Number label="DownloadedCount" v-model="item.downloadedCount" :editMode="editMode" @change="change" />
            </div>
            <div>
                <Boolean label="Shared" v-model="item.shared" :editMode="editMode" @change="change" />
            </div>
        </v-card-text>
